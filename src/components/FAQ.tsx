          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full flex items-center justify-between p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow"
              >
                <span className="text-lg font-medium text-secondary-900 text-left">
                  {faq.question}
                </span>
                <motion.svg
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="p-6 bg-white mt-2 rounded-xl shadow-lg">
